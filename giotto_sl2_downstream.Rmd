...
```{r Step4}
#Fig 4D
plotStatDelaunayNetwork(gobject = gem_nomix, maximum_distance = 400, save_plot = T, save_param = list(save_name = 'Fig 4d_dealunay_network_stats.pdf', save_folder = 'niche_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 7))
...
pdl1check_neigh_violin <-violinPlot(pdl1checkpoint_neigh, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32", "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'Fig6g_PDL1_myeloid_checkpoint_neigh_source.pdf', save_folder = 'Seurat/cosmx_seurat_withtcellidents_reedited_03Apr/gem_nomix',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 12))
...
pdl1check_source_violin<-violinPlot(pdl1checkpoint_source, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32",  "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'Fig6g_PDL1_myeloid_checkpoint_source.pdf', save_folder = 'Seurat/cosmx_seurat_withtcellidents_reedited_03Apr/gem_nomix',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 8))
...
violinPlot(ido1checkpoint_neigh, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32",  "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'Fig6h_ido1_myeloid_checkpoint_neigh.pdf', save_folder = 'Seurat/cosmx_seurat_withtcellidents_reedited_03Apr/gem_nomix',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 12))
...
plotMetaDataHeatmap(ido1pdl1checkpoint_CD8T_Treg, expression_values = 'scaled',
                    ...
                    selected_feats = topgini_genes_2 , save_param = list(save_name = 'Fig_6i_gem_neigh_heatmap.pdf', save_folder = 'Seurat/cosmx_seurat_withtcellidents_reedited_03Apr/gem_nomix',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 12))
