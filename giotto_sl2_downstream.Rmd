...
pdf(paste0(my_working_dir, "manuscript_plots/Fig4a_pdl1_ido1_overall_scatter.pdf"), height = 5, width=5)
...
```
### Step 4 (following on from Main Figure 4c: plot network stats and create network and assign neighbours
```{r Step4}
#Fig 4D
plotStatDelaunayNetwork(gobject = gem_nomix, maximum_distance = 400, save_plot = T, save_param = list(save_name = 'Fig 4d_dealunay_network_stats.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 7))
...
#Fig.4g-i
spatPlot2D(gobject = P3, cell_color = 'ido1_neighbour',point_size = 1.5, select_cell_groups = c("both", "neighbor", "others", "source"), cell_color_code= c("both"="#E31A1C", "others"= "#D9D9D9", "neighbor"= "green", "source" = "black"), show_legend = TRUE,point_shape = c("border"),save_param = list(save_name = 'Fig.4h_P3_mye_ido1_k_4_neighbour.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 7))

spatPlot2D(gobject = P3, cell_color = 'pdl1_neighbour',point_size = 1.0, select_cell_groups = c("both", "neighbor", "others", "source"), cell_color_code= c("both"="#E31A1C", "others"= "#D9D9D9", "neighbor"= "green", "source" = "black"), show_legend = TRUE,point_shape = c("border"),save_param = list(save_name = 'Fig.4i_P3_mye_pdl1_k_4_neighbour.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 7))

spatPlot2D(gobject = P3, cell_color = 'ido1pdl1_neighbour',point_size = 1.0, select_cell_groups = c("both", "neighbor", "others", "source"), cell_color_code= c("both"="#E31A1C", "others"= "#D9D9D9", "neighbor"= "green", "source" = "black"), show_legend = TRUE,point_shape = c("border"),save_param = list(save_name = 'Fig_4g_P3_mye_ido1pdl1_k_4_neighbour.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 7))
...
##################################################################################################################
##Data for UpsetR plots Fig. 4g-i
## for checkpoint
...
pdl1check_neigh_violin <-violinPlot(pdl1checkpoint_neigh, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32", "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'Fig6g_PDL1_myeloid_checkpoint_neigh_source.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 12))
...
pdl1check_source_violin<-violinPlot(pdl1checkpoint_source, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32",  "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'Fig6g_PDL1_myeloid_checkpoint_source.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 8))
...
violinPlot(ido1checkpoint_neigh, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32",  "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'Fig6h_ido1_myeloid_checkpoint_neigh.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 12))
violinPlot(ido1checkpoint_source, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32",  "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'ido1_myeloid_checkpoint_source.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 12))
...
ido1pdl1check_neigh_violin<- violinPlot(ido1pdl1checkpoint_neigh, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32",  "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'ido1pdl1_doublepos_myeloid_checkpoint_neigh.pdf', save_folder = 'manuscript_plots',save_format = 'pdf', units = 'in',
                           base_height = 12,
                           base_width = 9))

ido1pdl1check_neigh_violindata<-(ido1pdl1check_neigh_violin[["layers"]][[1]][["data"]])
write.csv(ido1pdl1check_neigh_violindata, paste0(my_working_dir, "/manuscript_plots/ido1pdl1check_neigh_violindata.csv"))
...
ido1pdl1check_source_violindata<- violinPlot(ido1pdl1checkpoint_source, feats = c("CCL18", "IL24", "IL1B", "IFNGR2", "CXCL9", "IL32",  "TNFSF14", "FASLG"), cluster_column = 'checkpoint', strip_position = 'right', 
           save_param = list(save_name = 'ido1pdl1_doublepos_myeloid_checkpoint_source.pdf', save_folder = '/manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 12))

ido1pdl1check_source_violindata<-(ido1pdl1check_source_violindata[["layers"]][[1]][["data"]])
write.csv(ido1pdl1check_source_violindata, paste0(my_working_dir, "/manuscript_plots/ido1pdl1check_source_violindata.csv"))
...
#adding additional phenotypic markers
topgini_genes_2 <- append(topgini_genes, values = c("GZMB", "GZMK", "IL16", "LTB", "LTR", "CSTW", "KLRK1", "MALAT1", "NEAT1", "SRGN", "GZMA", "MAF", "PRF1", "GNLY", "IL2RB", "IL2RA", "LAG3", "SELL", "CCR7", "CD69", "IL7R","LTB","CD8B", "CD8A", "CD3D", "HCST", "CD3G", "LINC02446", "CTSW", "CD3E","ANXA1", "KRT1","LINC02446","IL7R","CCL5", "GZMH",  "NKG7", "GZMK", "CST7", "FOXP3", "CD4", "TIGIT", "CTLA4"))
plotMetaDataHeatmap(ido1pdl1checkpoint_CD8T_Treg, expression_values = 'scaled',
                    metadata_cols = c('clusterf'),show_values = c("original"),
                    selected_feats = topgini_genes_2 , save_param = list(save_name = 'Fig_6i_gem_neigh_heatmap.pdf', save_folder = 'manuscript_plots/',save_format = 'pdf',
                           units = 'in',
                           base_height = 9,
                           base_width = 12))
...
cellProximityBarplot(gobject = gem_nomix,
                     ...
                     save_param = list(save_folder = 'manuscript_plots/', # Create subdirectory
...
spatPlot(smallfov, cell_color = 'ido1pdl1_cd8',show_network = T,point_size = 3,network_color = "blue", spatial_network_name = "nearest_spatial_network",
  ...
  save_param = list(save_folder = 'manuscript_plots/', # Create subdirectory
                           save_name = 'Fig5a_select_interactions_ido1pdl1_doublepos_cd8_mem',
                           save_format = 'pdf',
                           units = 'in',
                           dpi = 600,
                           base_height = 8,
...
spatPlot(smallfov, cell_color = 'ido1pdl1_treg',show_network = T,point_size = 3,network_color = "blue", spatial_network_name = "nearest_spatial_network",
  ...
  save_param = list(save_folder = 'manuscript_plots/', # Create subdirectory
                           save_name = 'Fig5b_select_interactions_ido1pdl1_treg',
                           save_format = 'pdf',
                           units = 'in',
                           dpi = 600,
                           base_height = 8,
...
spatPlot(smallfov, cell_color = 'ido1pdl1_ccl18',show_network = T,point_size = 3,network_color = "blue", spatial_network_name = "nearest_spatial_network",
  ...
  save_param = list(save_folder = 'manuscript_plots/', # Create subdirectory
                           save_name = 'Fig5c_select_interactions_ido1pdl1_doublepos_ccl18_mac',
                           save_format = 'pdf',
                           units = 'in',
                           dpi = 600,
                           base_height = 8,
...
ido1_pdl1_neigh_cellmetadata <- pDataDT(ido1pdl1checkpoint_neigh)
nomix_cell_metadata<- pDataDT(gem_nomix)
ido1pdl1checkpoint_neigh_CD8_Treg_NK_cell_IDs <- c((ido1_pdl1_neigh_cellmetadata$cell_ID[ido1_pdl1_neigh_cellmetadata$clusterf %in% c("T_CD8_mem", "Treg")]), nomix_cell_metadata$cell_ID[nomix_cell_metadata$clusterf %in% c("NK")])
ido1pdl1checkpoint_CD8T_Treg_nk = subsetGiotto(gem_nomix, cell_ids = ido1pdl1checkpoint_neigh_CD8_Treg_NK_cell_IDs)
sel_genes<- c("GZMB","LAG3", "TIGIT", "PDCD1","CTLA4","IL32")

violinPlot(ido1pdl1checkpoint_CD8T_Treg_nk, feats = sel_genes, cluster_column = 'clusterf', strip_position = 'right')
