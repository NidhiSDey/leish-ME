...
#Figure 5h, k and m, Supplemental fig. 6e
gene_list <- c("IDO1", "CD274", "CXCL9","IL32")
for (gene in gene_list){
  #feature <- top.features[spatial_feature]
  pdf(paste0(save_path, "Fig7f_Supple_Fig6e_Spatial_feature_", gene, ".pdf"))
...
pdf(paste0(save_path, "Fig7h_pkdl_pdl1_ido1_overall_scatter.pdf"), height = 5, width=5)
...
pdf(paste0(save_path, "Fig7f_supple_fig6e_ido1_pdl1_spatialplot_ido1dot5pdl1dot1.pdf"), height = 5, width=5)  
...
pdf(paste0(save_path, "Fig7k_pkdl_skin_merged_IDO1PDL1_dot_plots_de.pdf"),7,6)
