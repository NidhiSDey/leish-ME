...
pdf(paste0(save_path, "Fig.1k_sorted_all_box_cell2space_sd22.2.1.pdf"), height = 10, width=7)
...
pdf(paste0(save_path,"Supplementary Fig_2b_patient_sorted_all_box_cell2space_sd22.2.1.pdf"), height = 10, width=7)  
...
#Data extracted for Fig. 1L and then plotted on Graphpad
...
pdf(paste0(save_path, "SupplementaryFig.5c-l_celltypes_thresholded_my1_my2_my3_cell2space_sd22.2.1.pdf"), height =20, width=8)
...
pdf(paste0(save_path, "Fig.3A_pdl1_ido1_overall_scatter.pdf"), height = 5, width=5)
...
pdf(paste0(save_path,"Fig3L_ido1pdl1_sorted_all_box_cell2space_sd22.2.1.pdf"), height = 10, width=7)
