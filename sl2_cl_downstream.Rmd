...
#THE FOLOWING GRAPHS ARE THE BASIS OF Fig 1H-I and Ext_Data. Fig 1 H-i (left panels) and Supplementary Fig 2
Idents(nd2117SLCL_skin_merged) <- nd2117SLCL_skin_merged$morpho
...
pdf(paste0(save_path, "Suppl_Fig4a_ido1_pdl1_spots_dot_plots_DE_chemokines.pdf"))
...
pdf(paste0(save_path, "Suppl_Fig4_nd2117SLCL_skin_merged_dot_plots_ido1pdl1_checkpoints.pdf"))
  #for(cluster in 0:3){
